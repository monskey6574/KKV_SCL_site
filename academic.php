...
<!-- grade11 card -->
    ...
    <!-- grade11 card -->
        ...
        <!-- Add more card divs here following the same structure -->
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4">
            ...
            <h4>About us</h4>
            <p>Lorem Ipsum ist einfach Dummy-Text der Druck- und Satzindustrie. Lorem Ipsum war der Standard der Branche
          ...
          <div class="col-md-4">
            ...
            <ul class="social-icon">
              <li><a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor"
  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js"
    ...
    crossorigin="anonymous"></script>
  <script src="JS/academic.js" </body>
</html >